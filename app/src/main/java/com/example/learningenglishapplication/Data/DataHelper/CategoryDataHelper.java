...
public class CategoryDataHelper {
    ...
    public Cursor getAllCategories(long userId) {
        ...
        return db.query(DatabaseHelper.TABLE_CATEGORIES, null,
    ...
    public Cursor searchCategories(long userId, String query) {
        ...
        return db.query(DatabaseHelper.TABLE_CATEGORIES, null, selection, selectionArgs, null, null, DatabaseHelper.COLUMN_CAT_NAME);
    }
    ...
    public int updateCategory(long categoryId, String newName, String newDescription) {
        ...
        int result = db.update(DatabaseHelper.TABLE_CATEGORIES, values, DatabaseHelper.COLUMN_CAT_ID + " = ?", new String[]{String.valueOf(categoryId)});
        db.close();
        return result;
    }
    ...
    public void deleteCategory(long categoryId) {
        ...
        db.delete(DatabaseHelper.TABLE_CATEGORIES, DatabaseHelper.COLUMN_CAT_ID + " = ?", new String[]{String.valueOf(categoryId)});
        db.close();
    }
    ...
    public Map<String, Long> getCategoriesForSpinner(long userId) {
        ...
        Cursor cursor = db.query(DatabaseHelper.TABLE_CATEGORIES,
                new String[]{DatabaseHelper.COLUMN_CAT_ID, DatabaseHelper.COLUMN_CAT_NAME},
                DatabaseHelper.COLUMN_CAT_USER_ID + "=?",
        ...
        if (cursor.moveToFirst()) {
            do {
                long id = cursor.getLong(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_CAT_ID));
